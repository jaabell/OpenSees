...
TenNodeTetrahedronThermal::update(void)
{
	...
	// opserr << "TenNodeTetrahedronThermal::update -- 2" << endln;
	//compute basis vectors and local nodal coordinates
	computeBasis( ) ;

	// opserr << "TenNodeTetrahedronThermal::update -- 3" << endln;
	//gauss loop to compute and save shape functions
	...
	// opserr << "TenNodeTetrahedronThermal::update -- 4" << endln;

	//gauss loop
	for ( i = 0; i < numberGauss; i++ )
	{

		// opserr << "TenNodeTetrahedronThermal::update -- 4.1 i = " << i << endln;
		//extract shape functions from saved array
		for ( p = 0; p < nShape; p++ )
		{
			for ( q = 0; q < numberNodes; q++ )
		...
		//zero the strains
		strain.Zero( ) ;
		// opserr << "TenNodeTetrahedronThermal::update -- 4.2 i = " << i << endln;

		// j-node loop to compute strain
		for ( j = 0; j < numberNodes; j++ )  {

			// opserr << "TenNodeTetrahedronThermal::update -- 4.2.1 j = " << j << endln;
	...
	// opserr << "TenNodeTetrahedronThermal::update -- 5" << endln;
	// opserr << "TenNodeTetrahedronThermal::update -- END" << endln;
	return 0;
}
